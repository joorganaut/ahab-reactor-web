...
const Container = styled.label`
  ...
  position: relative;
  padding: 12px 10px;
  background-color: ${props=> props.theme.colors.navLink};;
...
const Caption = styled.div`
  ...
  top: -18%;
  font-size: 0.75rem;
  background: ${props=> props.theme.colors.navLink};
  padding: 0 3px;
  left: 10px;
...
`
export const DropDown: FC<{ data?: any[], label: string, onSelectChange: (e: any)=>void, selectedValue?: string }> = ({ data, label, onSelectChange, selectedValue }) => (
  <Label label={label}>
